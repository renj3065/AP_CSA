...
public class Magpie5
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "remington")>=0){
	...
	private String [] randomResponses = {"Interesting, tell me more",
			...
			"You don't say.","I don't think I understand","How interesting!","Sorry, I am a bit tired right now","I should tell my friends about that"
	};
