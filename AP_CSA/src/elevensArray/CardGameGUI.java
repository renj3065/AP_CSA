...
public class CardGameGUI extends JFrame implements ActionListener {
	...
	private static final int DEFAULT_HEIGHT = 302;//302
	/** Width of the game frame. */
	private static final int DEFAULT_WIDTH = 800;//800
	/** Width of a card. */
	private static final int CARD_WIDTH = 73;//73
	/** Height of a card. */
	private static final int CARD_HEIGHT = 97;//97
